...
public class PointCP5Test
{
  ...
  public static void main(String[] args)
  {
    ...
    System.out.println("\nYou entered:\n" + point);
    if(point.getType() == 'C'){
        PointCP5 newPoint = point.convertStorageToPolar();

        System.out.println("\nAfter asking to store as Polar:\n" + newPoint);
    } else{

        PointCP5 newPoint = point.convertStorageToPolar();
        System.out.println("After asking to store as Cartesian: " + newPoint);
    }

    System.out.println("Now enter another point to compute the distance: ");

    PointCP5 other = new PointCP2('P', 0, 0);
    ...
    System.out.println("Origin point: " + point);
    System.out.println("New point: " + other);
    System.out.println("The distance between two point is " + point.getDistance(other));
    
    double rot = 0.0;
    boolean get = false;

    while(!get){
        System.out.println("Enter the angle in degrees for rotation");
    ...
    PointCP5 afterRot = point.rotatePoint(rot);
